...
function renderAdminDashboard() {
  ...
  Promise.all([api('/employees'), api('/tasks'), workPromise]).then(function (r) {
    ...
    var stats = [
      ...
      ['#F59E0B', pending, 'Pending tasks', 'adminTasks', null],
      ['#22C55E', completed, 'Completed tasks', 'adminTasks', null],
...
function renderEmployeeDashboard() {
  ...
  Promise.all([api('/tasks'), api('/personal-tasks')]).then(function (r) {
    ...
    var stats = [
      ['#2563EB', all.length, 'My tasks', 'myTasks', null],
      ['#22C55E', completed, 'Completed', 'myTasks', null],
