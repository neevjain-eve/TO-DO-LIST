// Scheduled function (see netlify.toml) -- runs every 15 minutes.
...
exports.handler = async () => {
  if (!graph.configured()) {
    return { statusCode: 200, body: 'Microsoft Calendar sync not configured; nothing to do.' };
  }
  ...
  return { statusCode: 200, body: JSON.stringify({ ok: true, changes: log }) };
};
