...
// SESSION_SECRET environment variable in the Netlify site settings after
// deploying; the fallback below is only for local testing.
const crypto = require('crypto');

const SECRET = process.env.SESSION_SECRET || 'dev-only-secret-change-in-netlify-env-vars';
...
/** Pulls and verifies the bearer token from a Netlify Functions event. */
